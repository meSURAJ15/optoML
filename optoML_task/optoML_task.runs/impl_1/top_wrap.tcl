...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/Vivado/VIVADO Projects/optoML_task/optoML_task.cache/wt} [current_project]
  set_property parent.project_path {D:/Vivado/VIVADO Projects/optoML_task/optoML_task.xpr} [current_project]
  set_property ip_output_repo {{D:/Vivado/VIVADO Projects/optoML_task/optoML_task.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet {{D:/Vivado/VIVADO Projects/optoML_task/optoML_task.runs/synth_1/top_wrap.dcp}}
  link_design -top top_wrap -part xc7a200tfbg676-2
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_wrap_timing_summary_routed.rpt -rpx top_wrap_timing_summary_routed.rpx -warn_on_violation "
